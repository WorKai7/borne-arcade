...
class Difficulty_menu(Secondary_menu):
    def __init__(self, screen_size:tuple, sfx_state:bool) -> None:
        ...
        self.text = pygame.font.SysFont('arialrounded', int(self.image_width/24)).render("Choisissez la difficulté", True, (0, 0, 0))
    ...
    def draw(self, menu) -> bool:
        ...
        while running:
            ...
            menu.window.blit(self.text, (self.screen_size[0]/2.6, self.screen_size[1]/2.55))
