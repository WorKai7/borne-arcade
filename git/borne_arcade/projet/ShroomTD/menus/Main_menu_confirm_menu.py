...
class Main_menu_confirm_menu(Secondary_menu):
    def __init__(self, screen_size:tuple, sfx_state:bool) -> None:
        ...
        self.text = pygame.font.SysFont('arialrounded', int(self.image_width/27)).render("Voulez-vous retourner au menu pricipal ?", True, (0, 0, 0))
    ...
    def draw(self, game) -> bool:
        ...
        while running:
            ...
            game.window.blit(self.text, (self.screen_size[0]/3.2, self.screen_size[1]/2.3))
