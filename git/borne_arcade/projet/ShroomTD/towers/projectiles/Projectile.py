class Projectile:
    ...
    def handle(self, projectiles:list) -> list:
        ...
        calcule le coefficient directeur du vecteur entre le projectile et la cible
        ...
        vecteur = (self.target.x + self.target.width/2 - self.x, self.target.y + self.target.height/2 - self.y)
        if vecteur[0] != 0:
    ...
    def attack(self):
        ...
        raise NotImplementedError("Fonction pas implémenté pour cette classe")