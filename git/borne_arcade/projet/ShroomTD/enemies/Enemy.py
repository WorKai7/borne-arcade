...
class Enemy:
    ...
    def draw(self, window):
        ...
        if self.converted_image is None:
            self.converted_image = pygame.transform.scale(pygame.image.load(self.image_path).convert_alpha(), (self.width, self.height))
    ...
    def draw_health_bar(self, window):
        ...
        border_rect = pygame.Rect(self.x + self.width/7, self.y - self.height/15, BAR_LENGTH, BAR_HEIGHT)
        fill_rect = pygame.Rect(self.x + self.width/7, self.y - self.height/15, fill, BAR_HEIGHT)
        pygame.draw.rect(window, (50, 50, 50), border_rect)
        if self.health > self.max_health / 2:
            pygame.draw.rect(window, (0, 255, 0), fill_rect) # enemi avec tout sa vie vert 
    ...
    def draw_shield_bar(self, window):
        ...
        border_rect_boss = pygame.Rect(self.x + self.width/7, self.y - self.height/8, BAR_LENGTH, BAR_HEIGHT)
        fill_rect_boss = pygame.Rect(self.x + self.width/7, self.y - self.height/8, fill_boss, BAR_HEIGHT)
        pygame.draw.rect(window, (50, 50, 50), border_rect_boss)
        pygame.draw.rect(window, (150, 0, 255), fill_rect_boss) # enemi avec tout sa vie vert 
        ...
        for element in self.status:
            ...
            if status == "slowed":
                ...
                if duration == 0:
                    ...
                    self.resistance["Magic"] = int(round(self.max_resistance_magic * modifier))
                    element[1] -= 1
                ...
                if duration == 0:
                    ...
                    self.resistance["Physical"] = int(round(self.max_resistance_physic * modifier))
                    element[1] -= 1
